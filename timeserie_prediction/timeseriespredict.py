...
if input_train:
    time_train_dataset = TimeSeriesDataset(train_sample_length, n_train_samples, shift_time=shift, input_dim=input_dim, output_dim=output_dim, eval=False)
...
if eval_state is False:
    train_dataset = TimeSeriesDataset(train_sample_length, n_train_samples, shift_time=shift, input_dim=input_dim, output_dim=output_dim, eval=False)
    ...
    print(u"")
    pt_path = r'C:\Users\zhyuan\OneDrive - UGent\Desktop\ESN\checkpoint\esn_test.pt'

    torch.save(esn, pt_path)
else:
    test_dataset = TimeSeriesDataset(test_sample_length, n_test_samples, shift_time=shift, input_dim=input_dim, output_dim=output_dim, eval=True)
    ...
    plt.plot(test_y[3, :plot_length, 2].data, 'r', label='feat3_ori')
    plt.plot(y_predicted[3, :plot_length, 2].data, 'b', label='feat3_pred')

    plt.plot(test_y[3, :plot_length, 3].data, 'y', label='feat4_ori')
    plt.plot(y_predicted[3, :plot_length, 3].data, 'k', label='feat4_pred')
    plt.legend()
    ...
    plt.plot(test_y[12, :plot_length, 2].data, 'r', label='feat3_ori')
    plt.plot(y_predicted[12, :plot_length, 2].data, 'b', label='feat3_pred')

    plt.plot(test_y[12, :plot_length, 3].data, 'y', label='feat4_ori')
    plt.plot(y_predicted[12, :plot_length, 3].data, 'k', label='feat4_pred')
    plt.legend()
    plt.title('8_in_8_out')
    plt.show()
    ...
    plt.plot(test_y[14, :plot_length, 2].data, 'r', label='feat3_ori')
    plt.plot(y_predicted[14, :plot_length, 2].data, 'b', label='feat3_pred')

    plt.plot(test_y[14, :plot_length, 3].data, 'y', label='feat4_ori')
    plt.plot(y_predicted[14, :plot_length, 3].data, 'k', label='feat4_pred')
    plt.legend()
    plt.title('8_in_8_out')
    plt.show()
