...
class StackedESN(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, leaky_rate=1.0, spectral_radius=0.9, bias_scaling=0,
                 input_scaling=1.0, w_generator=None, win_generator=None, wbias_generator=None, sparsity=None, input_set=(1.0, -1.0),
        ...
        for n in range(self.n_layers):
            ...
            # ))
            self.esn_layers.append(LiESNCell(
                layer_leaky_rate, layer_input_dim, hidden_dim[n], layer_w, layer_w_in, layer_w_bias, layer_input_scaling,
                layer_nonlin_func,
            ))
        # end for
